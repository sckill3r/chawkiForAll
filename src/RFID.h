/**
 * Library to use Arduino RFID module.
 * 
...
#ifndef RFID_SPICLOCK
#define RFID_SPICLOCK (4000000u)	// RFID accept upto 10MHz, set to 4MHz.
#endif
...
const byte RFID_firmware_referenceV0_0[] PROGMEM = {
...
const byte RFID_firmware_referenceV1_0[] PROGMEM = {
...
// Version 2.0 (0x92)
// NXP Semiconductors; Rev. 3.8 - 17 September 2014; 16.1.1 self-test
const byte RFID_firmware_referenceV2_0[] PROGMEM = {
...
protected:
	byte _chipSelectPin;		// Arduino pin connected to RFID's SPI slave select input (Pin 24, NSS, active low)
	byte _resetPowerDownPin;	// Arduino pin connected to RFID's reset and power down input (Pin 6, NRSTPD, active low)
